...
{
    public class FrmOSChecklistWeb : Form
    {
        ...
        public FrmOSChecklistWeb(string initialData = "")
        {
            this.initialData = initialData;
            InitializeComponent();
            this.Load += FrmOSChecklistWeb_Load;
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTitle.Text = "Checklist Técnico";
        ...
        private void FrmOSChecklistWeb_Load(object sender, EventArgs e)
        {
            InitializeAsync();
        }
        ...
        async void InitializeAsync()
        {
            try
            {
                ...
                string path = MasterServicePro.Utils.WebPathResolver.GetHtmlPath(@"OSChecklist\index.html");
        ...
        {
            string safeJsString = JsonConvert.SerializeObject(initialData);
        ...
        private void CoreWebView2_WebMessageReceived(object sender, CoreWebView2WebMessageReceivedEventArgs e)
        {
            try
            {
                ...
                {
                    ChecklistResult = message.data.ToString();
